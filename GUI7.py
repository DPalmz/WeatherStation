...
# ***Humidity, temp and wind speed/direction always placed at bottom of page
hum_text = tk.StringVar(MainWindow)
humidity = Label(MainWindow, bd=4, relief="sunken", font="HelveticaNeue 40 normal", bg="royalblue4", fg="deepskyblue", textvariable=hum_text)
...
def polling(MainWindow):
    ...
    #polling(MainWindow)
    MainWindow.after(900, polling(MainWindow))                   # poll every 100ms
...
def weatherData():
    ...
    if(name1=="Moteino"):
            ...
            rainy = round(ArduinoFunctions.getRainVolume(data1[2]), 0)                #precipitation
            temp = round(data1[0] * 9/5 + 32, 0)                            #temperature converted from C to F, rounded
            ...
            windSpeed = round(ArduinoFunctions.getWindSpeed(data1[3]), 0)   #wind speed
